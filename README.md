...
| [`sfmc/amp-prefer-boolean-literal`](docs/rules/amp/prefer-boolean-literal.md)               | `warn`                   | Recommend bare booleans for accepted boolean-like parameter alternatives            |
