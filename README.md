...
| [`sfmc/amp-prefer-boolean-literal`](docs/rules/amp/prefer-boolean-literal.md)               | `warn`                   | Auto-fix all accepted boolean-like alternatives to recommended bare booleans         |
